...
exports.default = exports.states = exports.configure = void 0;

__webpack_require__(127);

var _jquery = _interopRequireDefault(__webpack_require__(125));

var _underscore = _interopRequireDefault(__webpack_require__(329));

__webpack_require__(330);

var _window2 = _interopRequireDefault(__webpack_require__(335));
...
var setActionEvent = function setActionEvent(actionName, actionsList, module) {
  switch (actionName) {
    case "close":
      {
        var closeAction = actionsList.find("[role=\"close-action\"]");
...
var configure = function configure(templates, handler) {
  if (_underscore.default.isObject(templates)) {
    actionTemplates = templates;
  }

  if (_underscore.default.isFunction(handler)) {
...
var _createWindow = function _createWindow(module) {
  var options = module.options;
  var zindex = parseInt(options["z-index"], 10);
  var windowWrapper = (0, _jquery.default)("<div class=\"window-wrapper\" data-role=\"wrapper\"></div>").css({
    "position": "fixed",
    "width": "100%",
    "height": "100%",
    "display": "none"
  }).appendTo(body);
  var windowOverlay = (0, _jquery.default)("<div class=\"window-overlay\"></div>").css({
    "position": "fixed",
    "width": "100%",
    "height": "100%",
    "z-index": zindex
  }).appendTo(windowWrapper);
  var windowHTML = (0, _window2.default)({
    title: options.title,
    footer: options.footer
  });
  var window = (0, _jquery.default)(windowHTML).css({
  ...
  if (_underscore.default.isArray(options.actions) && options.actions.length) {
...
var _createModalWindow = function _createModalWindow(window) {};
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(module, context) {
    var contentAJAX;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            contentAJAX = module.options.content;

            if (_underscore.default.isString(contentAJAX.fileName)) {
              contentAJAX = {
                type: "GET",
            ...
            } else if (!_underscore.default.isBoolean(contentAJAX.cache)) {
              contentAJAX.cache = false;
            }

            ;
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              _jquery.default.ajax(contentAJAX).done(function (responseHTML) {
  ...
  return function _loadContent(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

var _buildActions = function _buildActions(actions, window, module) {
  var actionsContainer = window.find(".header__actions");

  if (!actionsContainer.length) {
    actionsContainer = (0, _jquery.default)("<div class=\"header__actions\"></div>").prependTo(window);
  }

  var actionsList = (0, _jquery.default)("<ul class=\"header__actions-list\"></ul>").appendTo(actionsContainer);
  actions.forEach(function (actionName) {
    var actionTemplate = actionTemplates[actionName];

    if (!_underscore.default.isString(actionTemplate)) {
      return;
    }
...
var _animateIt = function _animateIt(element, className, callback) {
  element.addClass(className).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
...
function () {
  function Window(options) {
    ...
    this.options = _underscore.default.extend(defaultOptions, options);
    ...
    if (this.options.autoLoad) {
      this.init().then(function () {
        if (_underscore.default.isFunction(_this.options.onRelease)) {
          _this.options.onRelease.call(_this);
        }
      });
    }
  }
  ...
  _createClass(Window, [{
    ...
    value: function open() {
      ...
      if (this.state < states.WND_LOADED) {
        return;
      }

      this.wrapper.show();

      _animateIt(this.window, "play-open-animation", function () {
        _this2.state = states.WND_VISIBLE;
      });
    }
  }, {
    key: "close",
    value: function close() {
      ...
      if (this.state < states.WND_VISIBLE) {
        return;
      }

      _animateIt(this.window, "play-close-animation", function () {
        _this3.wrapper.hide();

        _this3.state = states.WND_HIDDEN;
      });
    }
  }, {
    key: "activate",
    value: function activate() {
      if (_underscore.default.isFunction(this.options.onActivate)) {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                if (!(this.state < states.WND_CREATED)) {
                  _context4.next = 2;
                  break;
                }
              ...
              case 2:
                context = this.window.find(this.options.contextSelector).eq(0);

                if (!_underscore.default.isString(this.options.content)) {
                  _context4.next = 7;
                  break;
                }
              ...
              case 7:
                _context4.next = 9;
                return _loadContent(this, context);
...
// module
exports.push([module.i, "@-moz-keyframes open-animation {\r\n  0% {\r\n    opacity: 0; }\r\n  100% {\r\n    opacity: 1; } }\r\n@-webkit-keyframes open-animation {\r\n  0% {\r\n    opacity: 0; }\r\n  100% {\r\n    opacity: 1; } }\r\n@keyframes open-animation {\r\n  0% {\r\n    opacity: 0; }\r\n  100% {\r\n    opacity: 1; } }\r\n@-moz-keyframes close-animation {\r\n  0% {\r\n    opacity: 1; }\r\n  100% {\r\n    opacity: 0; } }\r\n@-webkit-keyframes close-animation {\r\n  0% {\r\n    opacity: 1; }\r\n  100% {\r\n    opacity: 0; } }\r\n@keyframes close-animation {\r\n  0% {\r\n    opacity: 1; }\r\n  100% {\r\n    opacity: 0; } }\r\n/* line 37, ../scss/window.scss */\r\n.window-overlay {\r\n  background-color: rgba(69, 90, 100, 0.6); }\r\n\r\n/* line 41, ../scss/window.scss */\r\n.window__container {\r\n  background-color: #ffffff;\r\n  -moz-border-radius: 4px;\r\n  -webkit-border-radius: 4px;\r\n  border-radius: 4px;\r\n  -moz-box-shadow: 0 10px 6px -6px #455A64;\r\n  -webkit-box-shadow: 0 10px 6px -6px #455A64;\r\n  box-shadow: 0 10px 6px -6px #455A64;\r\n  font-family: \"Lato\", Helvetica, Arial, sans-serif;\r\n  color: rgba(0, 0, 0, 0.87); }\r\n  /* line 48, ../scss/window.scss */\r\n  .window__container.play-open-animation {\r\n    -moz-animation: open-animation 500ms ease 0s 1 normal backwards;\r\n    -webkit-animation: open-animation 500ms ease 0s 1 normal backwards;\r\n    animation: open-animation 500ms ease 0s 1 normal backwards; }\r\n  /* line 52, ../scss/window.scss */\r\n  .window__container.play-close-animation {\r\n    -moz-animation: close-animation 500ms ease 0s 1 normal backwards;\r\n    -webkit-animation: close-animation 500ms ease 0s 1 normal backwards;\r\n    animation: close-animation 500ms ease 0s 1 normal backwards; }\r\n\r\n/* line 57, ../scss/window.scss */\r\n.window__header-container {\r\n  position: relative; }\r\n  /* line 60, ../scss/window.scss */\r\n  .window__header-container .header__title {\r\n    width: 100%;\r\n    padding: 0 28px;\r\n    font-weight: 300;\r\n    font-size: 18px;\r\n    line-height: 72px;\r\n    color: rgba(0, 0, 0, 0.54);\r\n    text-transform: uppercase;\r\n    overflow: hidden;\r\n    white-space: nowrap;\r\n    text-overflow: clip; }\r\n  /* line 73, ../scss/window.scss */\r\n  .window__header-container .header__actions {\r\n    position: absolute;\r\n    width: auto;\r\n    height: 72px;\r\n    line-height: normal;\r\n    right: 0;\r\n    top: 0;\r\n    background-color: white; }\r\n    /* line 82, ../scss/window.scss */\r\n    .window__header-container .header__actions .header__actions-list {\r\n      list-style: none;\r\n      display: block;\r\n      position: relative;\r\n      height: 72px; }\r\n      /* line 88, ../scss/window.scss */\r\n      .window__header-container .header__actions .header__actions-list .window_action {\r\n        display: inline-block;\r\n        font-weight: 900;\r\n        font-size: 20px;\r\n        line-height: 72px;\r\n        vertical-align: top;\r\n        padding: 0 28px; }\r\n        /* line 96, ../scss/window.scss */\r\n        .window__header-container .header__actions .header__actions-list .window_action span {\r\n          cursor: pointer;\r\n          display: inline;\r\n          color: rgba(0, 0, 0, 0.36);\r\n          -moz-transition: color 250ms ease 0s;\r\n          -o-transition: color 250ms ease 0s;\r\n          -webkit-transition: color 250ms ease;\r\n          -webkit-transition-delay: 0s;\r\n          transition: color 250ms ease 0s; }\r\n          /* line 102, ../scss/window.scss */\r\n          .window__header-container .header__actions .header__actions-list .window_action span:hover {\r\n            color: rgba(0, 0, 0, 0.54); }\r\n\r\n/* line 111, ../scss/window.scss */\r\n.window__content-container {\r\n  padding: 21px 28px;\r\n  font-weight: 400;\r\n  font-size: 16px;\r\n  line-height: 20px; }\r\n\r\n/* line 118, ../scss/window.scss */\r\n.window__footer-container {\r\n  font-weight: 300;\r\n  font-size: 12px;\r\n  line-height: 36px;\r\n  text-align: center;\r\n  color: rgba(0, 0, 0, 0.54); }\r\n", ""]);
...
<div class="window__container">
    <header class="window__header-container">
        <div class="header__title">
            <span>${this.title}</span>
        </div>
        <div class="header__actions"></div>
    </header>
    <section class="window__content-container" data-role="context"></section>
    ${this.footer}
</div>`;
    }
...
var _window = _interopRequireWildcard(__webpack_require__(126));
